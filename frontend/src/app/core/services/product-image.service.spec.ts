...
describe('ProductImageService', () => {
  ...
  describe('uploadImage', () => {
    it('should validate file before uploading', async () => {
      ...
      await expectAsync(service.uploadImage('product-1', invalidFile))
  ...
  describe('getImagesByProductId', () => {
    it('should fetch images ordered by display_order', async () => {
      ...
      const result = await service.getImagesByProductId('product-1');
    ...
    it('should map database fields to TypeScript properties', async () => {
      ...
      expect(image.productId).toBe('phone-1');
    ...
    it('should throw error on query failure', async () => {
      ...
      await expectAsync(service.getImagesByProductId('product-1'))
