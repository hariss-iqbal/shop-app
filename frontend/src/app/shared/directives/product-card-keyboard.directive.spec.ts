...
import { ProductCardKeyboardDirective } from './product-card-keyboard.directive';

@Component({
  selector: 'app-test-host',
  imports: [ProductCardKeyboardDirective],
  template: `
...
class TestHostComponent {
  @ViewChild('card1', { read: ProductCardKeyboardDirective }) card1Directive!: ProductCardKeyboardDirective;
  @ViewChild('card2', { read: ProductCardKeyboardDirective }) card2Directive!: ProductCardKeyboardDirective;
...
describe('ProductCardKeyboardDirective', () => {
...
describe('ProductCardKeyboardDirective column estimation', () => {
  @Component({
